  ...
  <body class="light ">
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="{{route('admin.authenticate')}}" method="POST">
        @csrf
          <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="{{URL::to('/')}}">
          ...
          <div class="checkbox mb-3">
            <label>
              <input type="checkbox" name="remember" value="remember"> Stay logged in </label>
          </div>
