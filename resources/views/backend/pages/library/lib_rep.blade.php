                ...
                <div class="card-body" style="overflow-x: scroll">
                    <div class="toolbar row mb-3">
                        <div class="col ml-auto">
                            <div class="dropdown">
                                <a href="{{ URL::to('admin/AddBook') }}" class="btn btn-primary ml-3" type="button">Add more
                                    +</a>
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{URL::to('admin/edit/'.$data->id.'/book')}}">Edit</a>
                                            <a class="dropdown-item" href="{{ route('admin.showBookLang',$data->id) }}">Add Langauge & File</a>
                                            <a class="dropdown-item" href="{{ route('admin.showBookImages',$data->id) }}">Add Book Images</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 align="center" style="margin:0; text-align: justify">Are you sure you want to remove this Book and It's Data ?
                    </h4>
                </div>
