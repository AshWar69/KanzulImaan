    ...
    <div class="col-12">
        ...
        <div class="card shadow mb-4">
            <div class="card-header">
                <strong class="card-title">Add Book Image</strong>
            </div>
            <div class="card-body">
                <form action="{{route('admin.uploadBookImage')}}" method="POST" class="dropzone bg-light rounded-lg" id="tinydash-dropzone" enctype="multipart/form-data">
                    @csrf
