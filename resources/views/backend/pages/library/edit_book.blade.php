    ...
    <div class="col-12">
        ...
        <div class="card shadow mb-4">
            <div class="card-header">
                <strong class="card-title">Edit Library Book</strong>
            </div>
            <div class="card-body">
                <form id="bookSave" class="needs-validation" novalidate >
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control select2 select2-container--focus" name="category" required>
                                ...
                                @foreach ($categories as $cat)
                                    <option @if($data->category_id == $cat->id) selected @endif value="{{ $cat->id }}">{{ $cat->category_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="name" value="{{$data->name}}" required>
                            <div class="invalid-feedback"> Please Fill Up This Field </div>
                            <div class="valid-feedback"> Looks good! </div>
                            {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="author" value="{{$data->author}}" required>
                            <div class="invalid-feedback"> Please Fill Up This Field </div>
                            <div class="valid-feedback"> Looks good! </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationCustomUsername">Publisher</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="publisher" required value="{{$data->publisher}}">
                            <div class="invalid-feedback"> Please Fill Up This Field </div>
                            <div class="valid-feedback"> Looks good! </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom02">Pages</label>
                            <input type="text" class="form-control" id="validationCustom02" name="pages" required value="{{$data->total_pages}}">
                            <div class="valid-feedback"> Looks good! </div>
                            <div class="invalid-feedback"> Please Fill Up This Field. </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" id="quill_html" name="description" value="{{$data->description}}">
