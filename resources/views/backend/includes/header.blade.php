        ...
        <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
            ...
            <nav class="vertnav navbar navbar-light">
                ...
                <div class="w-100 mb-4 d-flex">
                    <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="{{ URL::to('Dashboard') }}">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item w-100">
                        <a class="nav-link" href="{{ URL::to('ProductsShowcase') }}">
                    ...
                    <li class="nav-item w-100">
                        <a class="nav-link" href="{{ URL::to('ShowOrders') }}">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="charts">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item w-100">
                        <a class="nav-link" href="{{URL::to('ManageBanner')}}">
                            <i class="fe fe-image fe-16"></i>
                            <span class="ml-3 item-text">Manage Banners</span>
                        </a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="nav-link" href="{{URL::to('ManageOrganisation')}}">
                            <i class="fe fe-home fe-16"></i>
                            <span class="ml-3 item-text">Manage Organisation</span>
                        </a>
                    </li>
                    <li class="nav-item w-100">
                        <a class="nav-link" href="{{URL::to('ManageSocialPlatform')}}">
