...
<li class="has-submenu">
    <a class="catLink" href="{{URL::to('books/category='.$childs->id)}}">{{ $childs->category_name }} <span class="ic text-dark" data-submenu="off-home{{$level}}"><i class="fa fa-angle-right"></i></span></a>
