            ...
            <div class="container">
                ...
                <div class="space-bottom-2 space-bottom-md-3">
                    <div class="text-center mb-5">
                        ...
                        <p class="text-gray-700">Signup to be the first to hear about exclusive deals, special offers and
                            upcoming
                            collections</p>
                    </div>
                        ...
                        <div class="pb-6">
                            ...
                            <div class="mb-4">
                                <a href="mailto:{{ $company->email }}"
                                    class="font-size-2 d-block link-black-100 mb-1">{{ $company->email }}</a>
                                <a href="tel:+91{{ $company->mobile }}"
                                    class="font-size-2 d-block link-black-100">+91-{{ $company->mobile }}</a>
                            </div>
        ...
        <div class="space-1">
            <div class="container">
                <div class="d-lg-flex text-center text-lg-left justify-content-between align-items-center">
                    ...
                    <p class="mb-3 mb-lg-0 font-size-2">©2020 {{ $company->company_name }}. All rights reserved</p>

                    <div class="ml-auto d-lg-flex align-items-center">
                        <p class="mb-3 mb-lg-0 font-size-2">Designed & Developed With <i
                                class="text-danger fa fa-heart"></i> By <a href="https://thedevbros.com">DevBros</a>.
                        </p>
                    </div>
                </div>
            </div>
...
<script src="{{ asset('front/vendor/slick-carousel/slick/slick.min.js') }}"></script>
