                    ...
                    <div class="container-fluid px-4 px-lg-8">
                        <div class="row align-items-center">
                            <div class="col-md-4 pt-8 pt-md-0">
                                <h1 class="product_title entry-title font-size-7 mb-3" id="bookName">{{ $book->name }}
                                </h1>
                                <div class="font-size-2 mb-4">
                                    <span class="mr-2 font-weight-medium">By (author)</span>
                                    <span class="mr-3 text-gray-600">{{ $book->author }}</span>
                                </div>
                                <div class="woocommerce-product-details__short-description font-size-2 mb-5">
                                    <p class="">{!! Str::of($book->description)->words(15, '.') !!}</p>
                                </div>
                            </div>
                            <div
                            ...
                            <div class="col-md-4 summary entry-summary">
                                <div class="">
                                    ...
                                    <div id="languages" class="row mx-gutters-2 mb-4">
                                        @php $i=1; @endphp
                ...
                <div class="woocommerce-tabs wc-tabs-wrapper mb-10 ">
                    <div class="container-fluid px-4 px-lg-8 bg-punch-light">
                        <div class="bg-white box-shadow-1 d-xl-flex">
                            <div
                                class="cart d-md-flex align-items-center flex-wrap ml-xl-auto order-xl-1 ml-6 ml-xl-0 pt-6 pt-xl-0">
                                @if ($book->type == 'book')
                                ...
                                <ul class="list-unstyled nav ml-md-5">
                                    @if ($book->type == 'book')
                                        <li class="mr-6 mb-4 mb-md-0">
                                            <a href="#" id="readBtn" class="h-primary"><i
