...
@section('tag')
    <span class="breadcrumb-separator mx-1"><i class="fas fa-angle-right"></i></span>{{$cat_name->category_name}}
@endsection
        ...
        <div class="container">
            <div class="row">
                <div id="primary" class="content-area order-2">
                    ...
                    {{$cat_books->onEachSide(3)->links('layouts.paginate')}}
                </div>
            </div>
        </div>
    </div>
