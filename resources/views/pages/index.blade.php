                        ...
                        <div class="js-slide">
                            <div class="hero row min-height-588 align-items-center">
                                ...
                                <div class="col-lg-5 col-wd-6" data-scs-animation-in="fadeInRight"
                                    ...
                                    <img class="img-fluid" src="{{ asset('back/images/banner_images/' . $ban->image) }}"
                                        alt="{{ $ban->heading }}">
                                </div>
                            </div>
                        </div>
                ...
                <li class="product-category col mb-4 mb-xl-0">
                    <div class="product-category__inner bg-tangerine-light px-6 py-5">
                        <div class="product-category__icon font-size-12 text-tangerine"><i
                                class="glyph-icon flaticon-cloud-computing"></i>
                        </div>
                        <div class="product-category__body">
                            <a href="{{ route('Kanzuliman.Bookslibrary') }}" target="_blank" class="stretched-link text-dark">
                                <h3 class="text-truncate font-size-3">Library</h3>
                                <a href="{{ route('Kanzuliman.Bookslibrary') }}" class="stretched-link text-dark">Visit Now</a>
                            </a>
                        </div>
                    </div>
                </li>
                <li class="product-category col mb-4 mb-xl-0">
                    <div class="product-category__inner bg-chili-light px-6 py-5">
                        <div class="product-category__icon font-size-12 text-chili"><i
                                class="glyph-icon flaticon-information"></i></div>
                        <div class="product-category__body">
                            <h3 class="text-truncate font-size-3">Research</h3>
                            <a href="#" class="stretched-link text-dark">See Now</a>
                        </div>
                    </div>
                </li>
                <li class="product-category col mb-4 mb-xl-0">
                    <div class="product-category__inner bg-carolina-light px-6 py-5">
                        <div class="product-category__icon font-size-12 text-carolina"><i
                                class="glyph-icon flaticon-heart"></i>
                        </div>
                        <div class="product-category__body">
                            <h3 class="text-truncate font-size-3">About Us</h3>
                            <a href="#" class="stretched-link text-dark">Have a Look</a>
                        </div>
                    </div>
                </li>
